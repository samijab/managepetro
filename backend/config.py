...
class Config:
    ...
    def _load_and_validate(self):
        ...
        self.GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "").strip() or os.getenv("gemenikey", "").strip()
        ...
        if not db_port_str:
            ...
            try:
                ...
                raise ConfigurationError(f"DB_PORT must be a valid integer, got: {db_port_str}")
